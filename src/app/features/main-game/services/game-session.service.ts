...
import { IssueStorageService } from '../../issue-management/services/issue-import.service.ts';
  ...
  async validateImportData(file: File): Promise<{
    ...
    try {
      ...
      return {
        ...
        preview: convertResult.validTickets.slice(0, 5), // First 5 tickets for preview
